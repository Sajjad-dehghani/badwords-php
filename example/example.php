...
{
    $dictionaryReject = new \Badword\Dictionary\Php('dictionary_reject.php', 2);
    $dictionaryModerate = new \Badword\Dictionary\Php('dictionary_moderate.php', 1);
    $config = new \Badword\Filter\Config\Standard();
    $filter = new \Badword\Filter(array($dictionaryReject, $dictionaryModerate), $config);
